...
<nav class="container-fluid navbar navbar-dark fixed-top bg-secondary">
  ...
  <form action="login" method="POST" class="form-inline">
    <input class="form-control-sm mr-sm-2 border-0 rounded" type="text" placeholder="Nome de Usuario" name="username">
    <input class="form-control-sm mr-sm-2 border-0 rounded" type="password" placeholder="Senha" name="password">
